...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('elementarysegmentgroup', models.ForeignKey(db_column='elementarySegmentGroup_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='nin.ninelementarysegmentgroup')),
                ('value', models.TextField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='NinGadmodifier',
            fields=[
                ('majortypelec', models.ForeignKey(db_column='majorTypeLEC_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='nin.ninmajortypelec')),
